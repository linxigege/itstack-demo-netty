 ...
 */
public abstract class ChannelAdapter2 extends Thread {
    private Selector selector;

    private ChannelHandler channelHandler;
    private Charset charset;

    public ChannelAdapter2(Selector selector, Charset charset) {
    ...
    public void run() {
        while (true) {
            try {
                ...
                // selects a set of keys whose corresponding channels are ready for io
