 ...
 */
public abstract class ChannelAdapter2 implements CompletionHandler<Integer, Object> {

    private AsynchronousSocketChannel channel;
    private Charset charset;

    public ChannelAdapter2(AsynchronousSocketChannel channel, Charset charset) {
