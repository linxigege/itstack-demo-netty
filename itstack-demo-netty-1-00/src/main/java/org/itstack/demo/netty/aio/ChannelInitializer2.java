 ...
 */
public abstract class ChannelInitializer2 implements CompletionHandler<AsynchronousSocketChannel,AioServer>{
    ...
    public void completed(AsynchronousSocketChannel channel,AioServer attachment){
        try {
            ...
            attachment.serverSocketChannel().accept(attachment,this);// receive this client again;
        }
    }
